...
-- Create and play the sound for Swift Sweep
local soundId = 18654280691  -- Correct sound ID
local sound = Instance.new("Sound")
sound.Name = "Swift_Sweep_Sound"
sound.SoundId = "rbxassetid://" .. soundId
sound.Volume = 1
sound.Pitch = 1.0
sound.PlaybackSpeed = 1.0
sound.Parent = character:FindFirstChild("HumanoidRootPart")  -- Parent to HumanoidRootPart or any other part of the character
sound:Play()
